# Simple CRUD project using React and Redux Toolkit. Searching feature also included.
...
5.  Search by Participant name

## Available Scripts

## Live Link (on netlify)

https://tubular-shortbread-80c344.netlify.app/
